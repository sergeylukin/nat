...
},{"./modules/city":2,"./modules/debounce":3,"./modules/device":4,"./modules/scrolling":7,"./modules/soundtrack":8,"./modules/svgstars":9,"./modules/viewport":10,"skrollr":12}],2:[function(require,module,exports){
...
},{"./viewport":10}],3:[function(require,module,exports){
...
},{"./viewport":10}],9:[function(require,module,exports){
...
module.exports = {
  ...
  initFrame: function () {
    frameStroke = paper.rect(
      viewport.width() / 2 - logoWidth / 2,
      viewport.height() / 2 - logoHeight / 2,
      logoWidth,
      logoHeight
    );
    frameStroke.attr({
  ...
  updateFrame: function () {
    frameStroke.attr({
      ...
      "data-900":
        "@transform[cubic]: translate(-" +
        (logoXCenteredOffset - logoXOffset) +
        " -" +
        (logoYCenteredOffset - logoYOffset) +
        ") scale(1) rotate(-180 " +
        viewport.width() / 2 +
        " " +
        viewport.height() / 2 +
    ...
    Array.prototype.forEach.call(letters, function (letterPath) {
      ...
      for (var i = 0; i < Snap.path.getTotalLength(letterPath); i += 4) {
        var p = Snap.path.getPointAtLength(letterPath, i),
          ...
          randomXcoordinate =
            originalXcoordinate + rand(rand(-400, -200), rand(200, 1000)),
          randomYcoordinate =
            originalYcoordinate + rand(rand(-300, -100), rand(300, 600)),
          centeredXcoordinate = p.x + textXCorrection + logoXCenteredOffset,
          centeredYcoordinate = p.y + textYCorrection + logoYCenteredOffset,
          randomOpacity = rand(0.01, 0.99);
...
},{"./letters":5,"./rand":6,"./viewport":10,"snapsvg":13}],10:[function(require,module,exports){
var w = window,
    d = document,
    e = d.documentElement,
